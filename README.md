...
1. How would you describe acessibility on the web to someone new to programming?
    - Accessibility on the web is making it easier for a person who has difficulties viewing the web easier to navigate (i.e. someone who is blind and uses text-to-speech). Also, we make it more accessible for those who use mobile devices and tablets by media queries.
2. Talk about 3 different things you can do to ensure your website is accessible. 
    - alt tag / alt text incase image does not load
    - media queries (desktop, laptop, phone, tablet)
    - choosing the right colors carefully for those who are visually impaired.
    - using the right headers to structure your content
3. How would you explain the concept of a variable to someone new to programming?
    - It means anything that can vary. It can hold data and it can be changed anytime. 
4. What is the purpose of using functions in code?
    - The purpose is to define a block a code and giving it a name. Designed to perform a particular task.
